...
namespace Ax.Engine.Core
{
    public static partial class Native
    {
        ...
        [DllImport("kernel32.dll", SetLastError = true)] public static extern bool GetConsoleCursorInfo([In] IntPtr hConsoleOutput, [Out] out CONSOLE_CURSOR_INFO lpConsoleCursorInfo);
        ...
        /// <returns>If the function succeeds, returns TRUE, otherwise, retun FALSE.</returns>
        [DllImport("kernel32.dll", SetLastError = true)] public static extern bool SetConsoleCursorPosition([In] IntPtr hConsoleOutput, [In] COORD dwCursorPosition);
    }
}