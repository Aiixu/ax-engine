namespace Ax.Engine.Core.Native
{
    ...
    {
        /// <summary>
        ///  Op codes for <see cref="BitBlt(System.IntPtr, int, int, int, int, System.IntPtr, int, int, int)"/>
        /// </summary>
        public enum BITBLT_OP : uint
        {
            /// <summary>
            ...
            /// <summary>
            ///  (Winver >= 5.0.0) Includes any windows that are layered on top of your window in the resulting image. By default, the image only contains your window. Note that this generally cannot be used for printing device contexts.
            /// </summary>
            ...
            /// <summary>
            ///  (Winver >= 5.0.0) Prevents the bitmap from being mirrored.
            /// </summary>
